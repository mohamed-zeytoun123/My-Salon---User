...
import 'package:my_salon/featchers/Home/presentation/widgets/image_slider_widget.dart';
      ...
      children: [
        ...
        BlocBuilder<HomeCubit, HomeState>(builder: (context, state) {
          if (state.isLoadingSliders) {
            ...
            return Center(child: Text("Error: ${state.errorSliders!.message}".tr()));
            ...
            return InkWell(
              ...
              child: ImageSliderWidget(
                  ...
                  height: 232.0082550048828.h,
                  width: double.infinity,
                  images: appImages),
            );
          } else {
            return Center(child: Text("No sliders available".tr()));
          }
        }),
      ],
    );
